...
| **ConversationDynamics.md** | Advanced dynamics reference | Comprehensive patterns |
...
├─ 1-on-1 casual? → ToConversation.md
├─ 1-on-1 formal? → ToPresentation.md
├─ Group 3+?      → ToDiscussion.md
└─ Need advanced? → ConversationDynamics.md
```
...
- You choose: style/participants
- LLM chooses: complexity/rounds
- No manual complexity decisions needed

**Self-Contained Formats**:
- Each core file includes context-specific essential dynamics (80/20)
- One-file workflow for most cases
- ConversationDynamics.md for advanced needs

**Fidelity**:
- Preserves all decision-critical content
- Facts, numbers, technical precision unchanged
- Transforms style/tone, not substance

**Audio-Only Ready**:
- All formats include audio adaptation guidance
- Remove visual refs, add confirmation markers
- Explicit structure for audio-only scenarios
...
**Three core formats** (self-contained, choose by context):
- `ToConversation.md` - Casual 1-on-1
- `ToDiscussion.md` - Group collaboration
- `ToPresentation.md` - Formal presentation

**One reference** (for advanced needs):
- `ConversationDynamics.md` - Comprehensive dynamics

**Result**: Self-contained formats, intelligent adaptation, realistic dialogue, optional depth
