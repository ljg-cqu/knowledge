...
**Answers** (sample ≥5): ≥2 dimensions | Concrete steps/frameworks with citations | Explicit trade-offs/alternatives | Evidence | Success criteria | Acknowledges limitations/assumptions
...
1. **Clarity**: Single ask | ✓ "3 stakeholders want conflicting features—how prioritize?" | ✗ "Explain Agile + Waterfall + risk management"
2. **Signal**: Tests judgment | ✓ "CEO demands 50% faster delivery—approach?" | ✗ "List PMBOK knowledge areas"
3. **Depth**: Enables trade-offs | ✓ "Choose: cut scope, add resources, or delay—how decide?" | ✗ "Should we use Gantt charts?"
4. **Realism**: Senior+ PM | ✓ "CTO wants replatform mid-project ($2M budget spent). What do?" | ✗ "Create project charter"
