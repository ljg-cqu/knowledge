...
-   **NIST P-256 (secp256r1)**：这是NIST推荐的标准曲线之一，也被称为`prime256v1`。它在NEO、部分企业级联盟链以及通用PKI/TLS证书体系中被广泛使用；以太坊2.0的验证者签名主要使用的是基于BLS12-381的聚合签名算法，而不是P-256 (Task 5, Task 10)。支持P-256可以帮助MPC钱包更好地对接这些企业级链和基础设施。
