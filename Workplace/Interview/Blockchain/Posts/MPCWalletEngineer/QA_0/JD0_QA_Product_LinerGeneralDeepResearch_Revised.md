...
**G7. FROST (Flexible Round-Optimized Schnorr Threshold)**
An advanced threshold signature scheme for Schnorr/EdDSA signatures offering efficient two-round online signing (with offline preprocessing) and provable security. It is designed to reduce round complexity compared to earlier Schnorr threshold schemes while remaining practical for high-throughput chains.
