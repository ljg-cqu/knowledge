...
**Task**: Extract linking words (conjunctions, connectors, discourse markers, transition expressions) that are essential for constructing complex sentences and expressing logical relationships from the **Miner** source text.
...
- Focus on linking words from **Miner** source that are essential for complex sentences and coherent communication
