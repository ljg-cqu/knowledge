# Extract Adjectives for Vocabulary Learning

**Task**: Extract adjectives (descriptive words, attributes, qualifiers) that are essential for language mastery from the source text about **Wallet**.
...
**Coverage:**
- Read entire source thoroughly—identify all adjectives that are decision-critical for understanding the text
...
**Focus:**
- Precise descriptive adjectives with specific meanings
...
- Focus on adjectives that are essential for understanding source content about **Wallet**
