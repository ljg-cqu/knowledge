# Extract Multi-Word Expressions for Vocabulary Learning: Under

**Task**: Extract multi-word expressions (collocations, idioms, phrases, fixed expressions) involving "under" that are essential for fluent, native-like communication from the source text.

**Definition**: Each entry focuses on one multi-word expression with "under" with comprehensive learning information including meaning, usage context, fixedness level, and examples across registers.

**Rules**:

**Coverage:**
- Read entire source thoroughly—identify all multi-word expressions with "under" that represent natural word partnerships or carry special meaning
- Prioritize: idiomatic expressions, prepositional phrases, verb + under combinations, fixed phrases with "under"
...
**Focus:**
- **Prepositional collocations with "under"**:
  - Position: under the table, under the bridge, under the surface
  - Authority: under supervision, under control, under management
  - Conditions: under the circumstances, under pressure, under stress
  - Process: under construction, under development, under review
  - State: under investigation, under consideration, under discussion
- **Idiomatic expressions with "under"**:
  - Under the weather (feeling ill)
  - Under the radar (unnoticed)
  - Under someone's thumb (controlled by someone)
  - Under the gun (under pressure with deadline)
  - Water under the bridge (past problems no longer relevant)
  - Sweep under the rug (hide problems)
- **Phrasal verbs with "under"**:
  - Go under (fail, sink)
  - Come under (be subjected to)
  - Fall under (be classified as)
  - Buckle under (collapse under pressure)
- **Verb + under collocations**:
  - Work under pressure
  - Operate under constraints
  - Perform under stress
  - Labor under misconception
...
- Focus on expressions with "under" that are essential for natural, fluent communication
...
- Pay special attention to prepositional phrases with "under" as they are highly productive
