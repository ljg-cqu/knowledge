...
Using the source book text stored at `{SOURCE_TXT_PATH}=/home/zealy/nas/github/ljg-cqu/knowledge/把握分析问题的九个方面.txt`, generate a comprehensive, well-structured wiki in
GitHub-Flavored Markdown and save it to `{TARGET_WIKI_MD_PATH}=/home/zealy/nas/github/ljg-cqu/knowledge/Books/把握分析问题的九个方面/Wiki.md`.
